...
public class StatusBarClockStyle extends PreferenceFragment implements OnPreferenceChangeListener {
	...
	public static StatusBarClockStyle newInstance() {
		return new StatusBarClockStyle();
	}
	...
	private PreferenceScreen createCustomView() {
		...
		mClockStyle.setValue(Integer.toString(Settings.System.getInt(getActivity().getContentResolver(),
	...
	public boolean onPreferenceChange(Preference preference, Object newValue) {
		...
		if (preference == mClockAmPmStyle) {
			...
			Settings.System
					.putInt(getActivity().getContentResolver(), Settings.System.STATUSBAR_CLOCK_AM_PM_STYLE, val);
			...
			if (index == CUSTOM_CLOCK_DATE_FORMAT_INDEX) {
				...
				alert.setPositiveButton(R.string.action_save, new DialogInterface.OnClickListener() {
	...
	public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
		menu.add(0, MENU_RESET, 0, R.string.action_reset).setIcon(R.drawable.ic_settings_reset)
	...
	private void parseClockDateFormats() {
		// Parse and repopulate mClockDateFormats's entries based on current
		// date.
	...
	public static class MyAlertDialogFragment extends DialogFragment {
		...
		public Dialog onCreateDialog(Bundle savedInstanceState) {
			...
			switch (id) {
			case DLG_RESET:
				return new AlertDialog.Builder(getActivity()).setTitle(R.string.action_reset)
