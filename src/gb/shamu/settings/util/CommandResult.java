package gb.shamu.settings.util;
...
public class CommandResult implements Parcelable {
	...
	public CommandResult(Parcel inParcel) {
		this(inParcel.readLong(), inParcel.readInt(), inParcel.readString(), inParcel.readString(), inParcel.readLong());
	}
	...
	private void checkForErrors() {
		if (mExitValue != 0 || !"".equals(mStderr.trim())) {
			...
			try {
				File errorLogFile = new File(Environment.getExternalStorageDirectory() + "/aokp/error.txt");
	...
	public String toString() {
		return "CommandResult{" + ", mStartTime=" + mStartTime + ", mExitValue=" + mExitValue + ", stdout='" + mStdout
				+ "'" + ", stderr='" + mStderr + "'" + ", mEndTime=" + mEndTime + '}';
	}
	...
	public boolean equals(Object o) {
		...
		return (mStartTime == that.mStartTime && mExitValue == that.mExitValue && mStdout == that.mStdout
